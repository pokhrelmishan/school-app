...
export default function StudentLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="grades" options={{ title: 'Grades', tabBarIcon: ({ focused }) => <TabIcon icon="📊" focused={focused} /> }} />
      <Tabs.Screen name="messages" options={{ title: 'Messages', tabBarIcon: ({ focused }) => <TabIcon icon="✉️" focused={focused} /> }} />
